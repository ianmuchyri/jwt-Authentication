...
// DeserializeUser is a middleware guard that ensures only authorized users with valid JWT's either in Authorization header,
// or cookie objects can access protected routes.
